...
public class runround {
	...
	public static boolean potential(long num) {
		// TODO Auto-generated method stub
		/*
		 * ArrayList<Character> chars = new ArrayList<Character>(); for(int i = 0; i <
		 * String.valueOf(num).length(); i++) { if(String.valueOf(num).charAt(i) == '0')
		 * { return false; }
		 * 
		 * if(chars.contains(String.valueOf(num).charAt(i))) { return false; }
		 * chars.add(String.valueOf(num).charAt(i)); } return true;
		 */
	...
	static class FastReader{
		...
		public FastReader() {
			try {
				br = new BufferedReader(new FileReader(new File("runround.in")));
