...
public class ttwoConsole {
	...
	public static void main(String[] args) throws IOException{
		out = new PrintWriter(System.out);//new BufferedWriter(new FileWriter("ttwo.out")));
...
//		System.out.println("cow start: " + toPointString(cow));//.toString());
	...
	static class FastReader{
		public FastReader() {
			br = new BufferedReader(new InputStreamReader(System.in));//FileReader("ttwo.in"));
		}
		String next() {
