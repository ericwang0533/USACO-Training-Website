...
//	public static ArrayList<Integer> cows = new ArrayList<Integer>();
	...
	public static void main(String[] args) throws IOException{
		out = new PrintWriter(System.out);//new BufferedWriter(new FileWriter("comehome.out")));
...
//		}
	...
	static class FastReader{
		public FastReader() {
			br = new BufferedReader(new InputStreamReader(System.in));//FileReader("comehome.in"));
		}
		String next() {
