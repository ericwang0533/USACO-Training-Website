...
public class zerosumConsole {
	...
	public static void main(String[] args) throws IOException{
		out = new PrintWriter(System.out);//new BufferedWriter(new FileWriter("zerosum.out")));
...
//		System.out.println();
	...
	static class FastReader{
		public FastReader() {
			br = new BufferedReader(new InputStreamReader(System.in));//FileReader("zerosum.in"));
		}
		String next() {
