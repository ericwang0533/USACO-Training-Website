...
public class hammingConsole {
	...
	public static void main(String[] args) throws IOException{
		out = new PrintWriter(System.out);//new BufferedWriter(new FileWriter("hamming.out")));
	...
	static class FastReader{
		...
		StringTokenizer st;
		public FastReader() {
			br = new BufferedReader(new InputStreamReader(System.in));//FileReader(new File("hamming.in")));
		}
		String next() {
